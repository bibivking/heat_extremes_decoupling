...
def main(fname, slope_type):
    ...
    # no data for matching gpp and Qle slopes, so drop from dataframe so we
...
=======
        ax.yaxis.set_major_locator(MaxNLocator(4))
        ax.set_ylim(0, 280)
>>>>>>> db692bb31cd723002caa0e878a65bffd3f79318a
        ax.set_xlim(18, 47)
        count += 1

    ofdir = "/Users/mdekauwe/Dropbox/fluxnet_heatwaves_paper/figures/figs"
    ofname = "all_events_Qle_FLUXNET_%s.pdf" % (slope_type)
